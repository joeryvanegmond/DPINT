...
namespace DPINT_Wk3_Observer.Model
{
    public abstract class Observable<T> : IObservable<T>, IDisposable
    {
        ...
        /// <summary>
        /// Deze private class gebruiken we om terug te geven bij de Subscribe methode. /// </summary>
        ...
        /// Hier geven we dan een seintje aan al onze observers dat we veranderd zijn. /// </summary>
